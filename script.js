...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const dummyWishes = [
        { name: "أحمد وعائلته", text: "ألف مليون مبروك للعروسين الجمال حسين وشهد! بارك الله لكما وبارك عليكما وجمع بينكما في خير.", date: "منذ ساعتين" },
        { name: "أميرة محمد", text: "يا رب يسعد قلوبكم ويجعل أيامكم كلها حب وهنا وفرحة. مبارك الزواج السعيد!", date: "منذ 5 ساعات" },
        { name: "خال العريس", text: "أتم الله فرحتكم على خير يا حسين يا بطل وسعدنا بشهد ابنةً كريمة لعائلتنا.", date: "منذ يوم" }
    ];
